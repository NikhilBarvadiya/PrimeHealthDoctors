...
//                           subtitle: 'Set distance for patient notifications',
//                           value: '${ctrl.notificationRange.value} km',
...
//                 child: Icon(Icons.location_on_rounded, color: AppTheme.primaryBlue, size: 40),
//               ),
//               const SizedBox(height: 16),
//               Text(
//                 'Notification Range',
...
//               const SizedBox(height: 8),
//               Text(
//                 'Set maximum distance to receive patient notifications',
...
//                       style: GoogleFonts.inter(fontSize: 24, fontWeight: FontWeight.w700, color: AppTheme.primaryBlue),
//                     ),
//                     const SizedBox(height: 16),
//                     Slider(
...
//                       children: [
//                         Text('1 km', style: GoogleFonts.inter(fontSize: 12, color: AppTheme.textSecondary)),
//                         Text('50 km', style: GoogleFonts.inter(fontSize: 12, color: AppTheme.textSecondary)),
//                       ],
//                     ),
//                   ],
//                 ),
